...
public class RuntimeInitializationConfigTest {
    ...
    public void testLoadConfig() throws Exception {
        ...
        checkMessage(errorsIt.next(),
                "Error deploying config empty-xml-config.xml (Could not resolve registration from file:",
                "config/empty-xml-config.xml (org.xml.sax.SAXParseException; Premature end of file.))", Level.ERROR,
                Source.CONFIG, "empty-xml-config.xml");
